...
parser = argparse.ArgumentParser(description="Realsense Aruco")
parser.add_argument("dif", type=str, help="variação no nome da variavel")
...
ARUCO_MARKER_LENGTH = 0.145 #0.15
ASSOC_DISTANCE_THRESHOLD = 1.5
MAX_MISSES = 10
DETECT_EVERY_N_FRAMES = 1

# HSV range
LOWER_TRESHOLD = np.array([43, 116, 110])
UPPER_TRESHOLD = np.array([78, 227, 255])
...
class RealsenseArucoHSV:
    ...
    def __init__(self):
        ...
        self.csv_path = os.path.join(CSV_DIR, f"ground_truth_{dif}.csv")
