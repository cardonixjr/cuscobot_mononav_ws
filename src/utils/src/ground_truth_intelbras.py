"""
READ IMAGES FROM THE INTELBRAS CAMERA AND CALCULATE THE GROUND TRUTH BY APLYING HSV THRESHOLD AND PARALAXE ADJUSTMENT
"""
...
Hc = 2.803 # Altura da camera
Hr = 0.35  # Altura do objeto colorido acima do robô

OFFSET_RODAS = 0.08  # 8 cm

lower_green = np.array([29, 77, 88])
upper_green = np.array([77, 218, 223])
...
while True:
    ...
    # ==========================================
    # DESENHAR RASTRO DA TRAJETÓRIA EM TEMPO REAL
    # ==========================================
    ...
    if len(trajectory_pixels) > 0:
        ...
        current_point = trajectory_pixels[-1]
...
FILENAME_BASE = "s_SIFT_RATIO_CLAHE_03"
csv_filename = (
